...
public interface ConsultaRepository extends JpaRepository<ConsultaEntity, Long> {
  ...
  List<ConsultaResponse> findAllByPacienteIdOrderByDataAsc(Long pacienteId);
  List<ConsultaResponse> findAllByPacienteIdOrderByDataAscHorarioAsc(Long pacienteId);
